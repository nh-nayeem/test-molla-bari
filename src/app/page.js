...
export default function Home() {
  return (
    <main className="flex min-h-screen flex-col items-center justify-between p-36">
      <div className="relative flex place-items-center font-bold">
        {/* <Image
          ...
          priority
        /> */}
        <h1 className="text-5xl font-semibold">Molla Bari</h1>
      </div>
      ...
      <div className="mb-32 grid text-center lg:max-w-5xl lg:w-full lg:mb-0 lg:grid-cols-3 lg:text-center">
        ...
        >
          ...
          <p className={`m-0 max-w-[30ch] text-sm opacity-50`}>
            A Tree containing all of Molla Bari.
          </p>
        </Link>
